        ...
        <NuxtLink :to="`/item/${product.id}`">
            ...
            <div id="ProductDetails">
                ...
                <div class="flex items-center gap-1 px-1 relative --top-1">
                    <span class="bg-[#FD374F] text-white text-[9px] fpnt-semibold px-1.5 rounded-sm">Welcome Deal</span>
                    <span class="bg-[#F5F5F5] border text-[#C08562] text-[9px] font-semibold px-1.5 runded-sm">Top Selling</span>
                </div>
