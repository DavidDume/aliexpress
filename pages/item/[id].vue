            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[60%] bg-white p-3 rounded-lg">
                    ...
                    <div class="flex items-center pt-1.5">
                        <span class="h-4 min-2-4 rounded-full p-0.5 bg-[#FFD000] mr-2">
                            <Icon name="material-symbols:star-rounded" class="-mt-[17px]" size="17" />
                        </span>
                    ...
                    <div class="flex items-center justify-start my-2">
                        ...
                        <Icon name="ic:baseline-star" color="#FF5353" />
                        <Icon name="ic:baseline-star" color="#FF5353" />
                        <span class="text-[13px] font-light ml-2"> 5 231 Reviews 1,000+ Orders</span>
                    </div>
                    ...
                    <p class="text-[#009A66] text-xs font-semibold pt-1">
                        Free 10-day delivery over $12.58
                    </p>
                    <p class="text-[#009A66] text-xs font-semibold pt-1">
                        Free Shipping
                    </p>
...
onMounted(() => {
    watchEffect(() => {
        currentImage.value = 'https://picsum.photos/id/82/800/800'
        images.value[0] = 'https://picsum.photos/id/87/800/800'
